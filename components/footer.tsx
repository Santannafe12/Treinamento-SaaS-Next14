...
export const Footer = () => {
    return (
        <div className="text-center w-full mt-24 py-8 bg-white min-h-[250px] flex flex-col items-center justify-center">
            <a href="/" className="flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                <Image src="https://www.svgrepo.com/show/499962/music.svg" className="h-12 mr-3 sm:h-9" alt="Landwind Logo" width={50} height={50} />
                summitStore
            </a>
